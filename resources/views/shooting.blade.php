...
@section('content')
    ...
    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel" style="margin-top:50px">
        <div class="carousel-inner mainslider">
            <div class="carousel-item active">
                <img class="d-block  justify-content-center  rounded" src="images/1.jpg" alt="First slide">
            </div>
    ...
    <h1 class="text-center" style="margin-top:70px">Shooting games</h1>
    ...
    <div class="container" style="margin-top:30px; margin-right:60px">
        <h2 class="ml-2">Shooting Game Reviews</h2>
        <div class="row">
            <div class="col-md-10">
